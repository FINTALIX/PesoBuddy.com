...
<head>
    ...
    <base href="http://localhost/FINTALIX/PesoBuddy/PesoBuddy.com/">
...
<body class="min-vh-100"
    style="background-image: url('assets/images/404-bg.png'); background-size: cover; background-repeat: no-repeat; margin: 0; padding: 0;">

    <img src="assets/images/404-pig.png" alt="404 Pig" class="position-fixed top-0 start-0 w-100 h-100"
    ...
    <div class="container min-vh-100 d-flex align-items-center justify-content-center me-5 position-relative"
        ...
        <div class="row align-items-center w-100">
            ...
            <div class="col-md-6 text-center">
                <h1 class="heading text-black mb-3" data-aos="fade-up" data-aos-duration="1000">The page isn't in the
                    vault</h1>
                ...
                <div class="paragraph text-black mb-5 mt-3" style="font-size: 1.2rem;" data-aos="fade-up"
